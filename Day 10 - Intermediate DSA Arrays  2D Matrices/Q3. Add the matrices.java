 ...
 * Note: Matrices are of same size means the number of rows and number of
 * columns of both matrices are equal.
 * 
 ...
 * Problem Constraints
 * 
 * 1 <= A.size(), B.size() <= 1000 1 <= A[i].size(), B[i].size() <= 1000 1 <=
 * A[i][j], B[i][j] <= 1000
 * Input Format
 * 
 * The first argument is the 2D integer array A The second argument is the 2D
 * integer array B
 * Output Format
 * 
